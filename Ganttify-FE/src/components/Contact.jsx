      ...
      <div className="h-[574px] w-[600px] p-[32px] bg-white rounded-3xl shadow-md ">
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <textarea
              id="message"
              className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline h-[250px]"
              value={message}
          ...
          <button type="button" className="text-white bg-[#000000]  font-medium rounded-[16px]  px-[45px] py-[13px] border-zinc-700 border-[1px] lg:w-full ">Submit</button>
        </form>
      </div>
    </div>
  );
